...
<body>
        ...
        <ul>
          ...
          <li class="drop-down"><a href="">PPDB Online</a>
            <ul>
              ...
              <li><a href="https://s.id/Aplikasi_SPMB_KabSoppeng_2025-2026" target="_blank">Daftar Sekarang</a></li>
              @endif
            </ul>
          </li>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 pt-5 pt-lg-0 order-2 order-lg-1 d-flex flex-column justify-content-center">
          ...
          <div class="d-flex">
            <a href="https://s.id/Aplikasi_SPMB_KabSoppeng_2025-2026" class="btn-get-started scrollto" target="_blank">Daftar Sekarang</a>
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-6 pt-4 pt-lg-0 content">
            ...
            @if ($informasi_pendaftaran->status==1)
            <a href="https://s.id/Aplikasi_SPMB_KabSoppeng_2025-2026" class="btn btn-success" target="_blank" disabled>Daftar Sekarang</a>
            @else
  ...
  <footer id="footer">
    <div class="container footer-bottom clearfix">
      <div class="copyright">
        SDN 143 Limpotenga | <strong><span>2025</span></strong>. All Rights Reserved
      </div>
      {{-- <div class="credits">
